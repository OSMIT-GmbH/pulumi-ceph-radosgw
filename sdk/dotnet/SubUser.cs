...
namespace OsmitGmbh.CephRadosgw
{
    ...
    public partial class SubUser : global::Pulumi.CustomResource
    {
        ...
        [Output("keyType")]
        public Output<OsmitGmbh.CephRadosgw.KeyType?> KeyType { get; private set; } = null!;

        [Output("keys")]
        public Output<ImmutableArray<Outputs.KeyEntry>> Keys { get; private set; } = null!;

        [Output("permissions")]
        public Output<OsmitGmbh.CephRadosgw.SubUserPermission> Permissions { get; private set; } = null!;
    ...
    public sealed class SubUserArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("keyType")]
        public Input<OsmitGmbh.CephRadosgw.KeyType>? KeyType { get; set; }

        [Input("permissions", required: true)]
        public Input<OsmitGmbh.CephRadosgw.SubUserPermission> Permissions { get; set; } = null!;
