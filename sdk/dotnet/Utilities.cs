...
namespace OsmitGmbh.CephRadosgw
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("OsmitGmbh.CephRadosgw.version.txt");
    ...
    internal sealed class CephRadosgwResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public CephRadosgwResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
