module github.com/OSMIT-GmbH/pulumi-ceph-radosgw/tests

go 1.21

replace github.com/OSMIT-GmbH/pulumi-ceph-radosgw/provider => ../provider

require (
	github.com/OSMIT-GmbH/pulumi-ceph-radosgw/provider v0.0.0-00010101000000-000000000000
