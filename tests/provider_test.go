...
import (
	...
	cephradosgw "github.com/OSMIT-GmbH/pulumi-ceph-radosgw/provider"
)
...
func provider() integration.Server {
	return integration.NewServer(cephradosgw.Name, semver.MustParse("1.0.0"), cephradosgw.Provider())
}
